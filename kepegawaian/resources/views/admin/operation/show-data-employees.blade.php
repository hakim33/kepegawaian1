<html>
  <body>
    <div class="shsearch animasi">
      <input type="text" id="inpsearch" onclick="expand_search('shsearch',1)" onblur="expand_search('shsearch',0)" placeholder="Cari data pegawai" class="search">
    </div>
    <div id="content">
      @if (count($datas)>0)
              ...
              <tr>
                ...
                <td width="120px" rowspan="4">
                  <div class="panelimg">
                      ...
                      @endphp
                    <img id="img{{$data->nip}}" class="thumbnail" src="{{$url}}">
                  </div>
                </td>
    ...
    <script type="text/javascript">
      ...
      $input.on('keyup', function () {
        ...
        if($("#inpsearch").val()!=""){
          typingTimer = setTimeout(function(){ajax_operation("get","admin/search-employee/"+$('#inpsearch').val()+"/"+{{$sts}},"content");},500);
        }else{
          typingTimer = setTimeout(function(){ajax_operation("get","admin/search-employee/default/"+{{$sts}},"content");},10);
        }
      });
